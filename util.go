...
import (
	...
	"github.com/lucasepe/markdown/internal/html"
	"github.com/lucasepe/markdown/internal/puny"
	"github.com/lucasepe/markdown/internal/url"
)
...
func normalizeLink(rawURL string) string {
	...
	return url.Encode(parsed.String())
}

func normalizeLinkText(rawURL string) string {
	parsed, err := url.Parse(rawURL)
	if err != nil {
		return ""
	}
	...
	return url.Decode(parsed.String())
}
